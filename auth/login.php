...
<section class="ld-section">
    <div class="container">
        ...
        <div class="ld-form-card">
            <form method="post" action="<?= APP_URL ?>/auth/process_login.php" class="needs-validation"
                ...
                <div class="mb-3">
                    ...
                    <input type="email" id="email" name="email" value="<?= e(old_input('email')) ?>"
                    ...
                    <div id="email_error" class="invalid-feedback">
                        <?= e($field_errors['email'] ?? 'Please enter a valid email address.') ?></div>
                </div>
