            ...
            <form method="post" enctype="multipart/form-data" class="needs-validation" data-inline-validate="true"
                ...
                <div class="mb-3">
                    ...
                    <input id="image" type="file"
                        ...
                        accept="image/*" aria-label="Product image"
                        aria-describedby="image_help<?= !empty($fieldErrors['image']) ? ' image_error' : '' ?>">
                    <div id="image_help" class="form-text">Upload a clear product image. Ensure customer-facing pages
                        include descriptive alt text or mark decorative images with empty alt text.</div>
