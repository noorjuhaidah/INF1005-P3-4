    ...
    <div class="container text-center">
        ...
        <div class="ld-search-wrap mt-4 mx-auto">
            ...
            <input
                type="search"
                id="menuSearch"
                class="form-control ld-search-input"
...
<section class="ld-section-sm">
    <div class="container">
        ...
        <div class="ld-filter-tabs mb-4" role="tablist" aria-label="Filter by category">
            <button class="ld-filter-btn active" data-filter="all"
        ...
        <div class="row g-4" id="menuGrid">
            ...
            >
                <article class="ld-card h-100 d-flex flex-column"
                         aria-label="<?= e($item['item_name']) ?>">

                    <img
                        src="<?= $imgSrc ?>"
                        alt="<?= e($item['item_name']) ?>"
                        class="card-img-top ld-menu-img"
                        loading="lazy"
                    >
                    ...
                    <div class="card-body d-flex flex-column p-4">
                        ...
                        <div class="ld-menu-actions mt-3">
                            ...
                            <!-- Add to cart form -->
                            <form
                                action="<?= APP_URL ?>/cart/add_to_cart.php"
                                method="POST"
                            ...
                            >
                                ...
                                <div class="qty-wrapper d-flex align-items-center border rounded-pill px-2">
                                    ...
                                    <input
                                        type="number" name="qty" class="qty-input"
...
.ld-search-input {
    ...
    border: 2px solid var(--ld-blue-light); font-size: 0.95rem; transition: border-color 0.2s;
}
.ld-search-input:focus {
    border-color: var(--ld-blue-dark);
    box-shadow: 0 0 0 0.2rem rgba(126,200,227,0.25);
}
.ld-filter-tabs { display: flex; gap: 0.5rem; flex-wrap: wrap; }
.ld-filter-btn {
    padding: 0.35rem 1.1rem; border-radius: 999px;
    border: 2px solid var(--ld-blue-light); background: #fff;
